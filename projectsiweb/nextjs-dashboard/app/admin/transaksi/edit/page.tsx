    ...
    <main className='flex min-h-screen flex-col p-6 bg-yellow-100'>
      <div className="mt-24">
        <div className="bg-white w-full h-96 border-red-800 border-2 rounded-lg ">
          <div className='mt-5'>
            <span className={`${poppins.className} text-2xl font-bold ml-4`}>Formulir Edit Transaksi</span>
            <div className="mt-5">
              <span className={`${poppins.className} text-base font-semibold ml-4`}>Kode Transaksi</span>
              <input
                placeholder='Masukkan kode transaksi yang baru'
            ...
            <div className='mt-7 flex justify-end'>
              ...
              <div className='mr-10'>
                <button className={`${poppins.className} text-lg font-semibold w-32 h-14 border-black border-2 text-black rounded-full bg-yellow-300 hover:text-white transition-colors`}>Edit</button>
              </div>
            </div>
          </div>
        </div>
